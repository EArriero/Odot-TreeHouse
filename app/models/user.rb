class User < ActiveRecord::Base
  # Comment. has_secure_password is a Rails feature that we use to implement password authentication functionality on our user model.
  has_secure_password
  ...
  def create_default_lists
    #Comment. find_or_create_by is a RoR built in method.    
